...
<div class="d-flex justify-content-between align-items-center mb-3">   <h6 class="fw-semibold mb-0" style="color: #333333;">Data Penulis</h6>   <a href="<?php echo e(route('penulis.create')); ?>" class="btn btn-sm btn-success">   + Tambah Penulis  
 </a>  
</div>  
...
<img src="<?php echo e(asset('storage/foto/' . $item->foto)); ?>"  
 alt="Foto <?php echo e($item->nama_depan); ?>"   style="width: 40px; height: 40px;   object-fit: cover; border-radius: 6px;   border: 1px solid #e9ecef;">   </td>  
