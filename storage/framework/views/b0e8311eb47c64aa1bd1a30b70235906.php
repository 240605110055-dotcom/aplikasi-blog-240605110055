...
<li class="nav-item"><a class="nav-link" href="<?php echo e(route('public.index')); ?>">Beranda</a></li>
<li class="nav-item"><a class="nav-link btn-login ms-2" href="<?php echo e(route('login')); ?>">Login</a></li>
</ul>
</div>
</div>
</nav>
...
<small>&copy; <?php echo e(date('Y')); ?> Blog Kami. Seluruh hak cipta dilindungi.</small>
</div>
</footer>
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/js/bootstrap.bundle.min.js"></script>
</body>
</html><?php /**PATH C:\xampp\htdocs\aplikasi-blog\resources\views/layouts/public.blade.php ENDPATH**/ ?>